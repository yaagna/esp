...
package socmap is
  ...
  constant CFG_FABTECH : integer := stratix10;
  ...
  -- Accelerators
  constant accelerators_num : integer := 1;

  -- Accelerator 0
  -- APB 84
  -- FUSEML_RTL
  constant fuseml_rtl_0_pindex : integer range 0 to NAPBSLV - 1 := 84;
  constant fuseml_rtl_0_pirq : integer range 0 to NAHBIRQ - 1 := 5;
  constant fuseml_rtl_0_irq_type : integer range 0 to 1 := 0;
  constant fuseml_rtl_0_paddr : integer range 0 to 4095 := 16#100#;
  constant fuseml_rtl_0_pmask : integer range 0 to 4095 := 16#FFF#;
  constant fuseml_rtl_0_paddr_ext : integer range 0 to 4095 := 16#000#;
  constant fuseml_rtl_0_pmask_ext : integer range 0 to 4095 := 16#000#;
  constant fuseml_rtl_0_pconfig : apb_config_type := (
  0 => ahb_device_reg (VENDOR_SLD, SLD_FUSEML_RTL, 0, 0, 5),
  1 => apb_iobar(16#100#, 16#FFF#),
  2 => (others => '0'));
  ...
  constant tile_design_point : tile_hlscfg_array := (
    2 => HLSCFG_FUSEML_RTL_BASIC_DMA64,
    others => 0);
