...
entity top is
  ...
  port (
    ...
    c0_ddr4_act_n    : out   std_logic_vector(0 downto 0);		-- changed from std_ulogic to vector
    c0_ddr4_adr      : out   std_logic_vector(16 downto 0);
    c0_ddr4_ba       : out   std_logic_vector(1 downto 0);
    c0_ddr4_bg       : out   std_logic_vector(1 downto 0);		-- chnaged from 0 to 0 to 1 to 0
    c0_ddr4_cke      : out   std_ulogic;				-- changed from vector to std_ulogic
    c0_ddr4_odt      : out   std_ulogic;				-- changed from vector to std_ulogic
    c0_ddr4_cs_n     : out   std_ulogic;				-- changed from vector to ulogic
    c0_ddr4_ck_t     : out   std_logic_vector(0 downto 0);
    c0_ddr4_ck_c     : out   std_logic_vector(0 downto 0);
    c0_ddr4_reset_n  : out   std_logic_vector(0 downto 0);		-- changed from ulogic to vector
    ...
    oct_rzqin: in std_logic;					-- added as placeholder
    dummy: in std_logic_vector(0 downto 0));			-- added as placeholder
  ...
  gen_mig : if (SIMULATION /= true) generate     
	...
	generic map (
	  ...
	  haddr  => ddr_haddr(0),
          hmask  => ddr_hmask(0))
	port map (
          pll_ref_clk    => c0_sys_clk_p,
	  oct_rzqin      => oct_rzqin,		--- placeholder
	  mem_ck         => open,		--- placeholder
	  mem_ck_n       => open,		--- placeholder
	  mem_a          => c0_ddr4_adr,
	  ...
	  mem_par	 => open,			--- placeholder
	  mem_alert_n	 => dummy,			--- placeholder
	  mem_dqs	 => c0_ddr4_dqs_c,
	  mem_dqs_n	 => c0_ddr4_dqs_t,
	  mem_dq	 => c0_ddr4_dq,
	  mem_dbi_n	 => c0_ddr4_dm_dbi_n,
	  --amm_ready_0	 => open, 
	  ---amm_read_0	 => open,
	  --amm_write_0	 => open,
	  --amm_address_0	 => open,
	  --amm_burstcount_0 => open,
	  --amm_readdatavalid_0 => open,
	  ahb_clk	 => reset,		--- placeholder
	  ahb_rst	 => reset,		--- placeholder
	  ahbsi		 => ddr_ahbsi(0),
	  ahbso		 => ddr_ahbso(0)
	);	
