...
architecture rtl of noc_fuseml_rtl is

  -- Device ID and revision numner
  constant vendorid      : vendor_t               := VENDOR_SLD;
  constant revision      : integer                := 0;
  constant exp_registers : integer range 0 to 1   := 0;
  constant devid         : devid_t                := SLD_FUSEML_RTL;
  constant tlb_entries   : integer                := 4;

  -- User defined registers
  -- bank(16): reg10
  constant FUSEML_RTL_REG10_REG : integer range 0 to MAXREGNUM - 1 := 16;

  -- bank(17): reg8
  constant FUSEML_RTL_REG8_REG : integer range 0 to MAXREGNUM - 1 := 17;

  -- bank(18): reg9
  constant FUSEML_RTL_REG9_REG : integer range 0 to MAXREGNUM - 1 := 18;

  -- bank(19): reg2
  constant FUSEML_RTL_REG2_REG : integer range 0 to MAXREGNUM - 1 := 19;

  -- bank(20): reg3
  constant FUSEML_RTL_REG3_REG : integer range 0 to MAXREGNUM - 1 := 20;

  -- bank(21): reg1
  constant FUSEML_RTL_REG1_REG : integer range 0 to MAXREGNUM - 1 := 21;

  -- bank(22): reg6
  constant FUSEML_RTL_REG6_REG : integer range 0 to MAXREGNUM - 1 := 22;

  -- bank(23): reg7
  constant FUSEML_RTL_REG7_REG : integer range 0 to MAXREGNUM - 1 := 23;

  -- bank(24): reg4
  constant FUSEML_RTL_REG4_REG : integer range 0 to MAXREGNUM - 1 := 24;

  -- bank(25): reg5
  constant FUSEML_RTL_REG5_REG : integer range 0 to MAXREGNUM - 1 := 25;
  ...
  constant available_reg_mask : std_logic_vector(0 to MAXREGNUM - 1) := (
    ...
    YX_REG             => '1',
    SPANDEX_REG        => '1',
    FUSEML_RTL_REG10_REG                => '1',
    FUSEML_RTL_REG8_REG                 => '1',
    FUSEML_RTL_REG9_REG                 => '1',
    FUSEML_RTL_REG2_REG                 => '1',
    FUSEML_RTL_REG3_REG                 => '1',
    FUSEML_RTL_REG1_REG                 => '1',
    FUSEML_RTL_REG6_REG                 => '1',
    FUSEML_RTL_REG7_REG                 => '1',
    FUSEML_RTL_REG4_REG                 => '1',
    FUSEML_RTL_REG5_REG                 => '1',
    others             => '0');
...
begin
  ...
  fuseml_rtl_rlt_i: fuseml_rtl_rtl
    generic map (
      hls_conf => hls_conf
    )
    port map(
      conf_info_reg10            => bank(FUSEML_RTL_REG10_REG)(31 downto 0),
      conf_info_reg8             => bank(FUSEML_RTL_REG8_REG)(31 downto 0),
      conf_info_reg9             => bank(FUSEML_RTL_REG9_REG)(31 downto 0),
      conf_info_reg2             => bank(FUSEML_RTL_REG2_REG)(31 downto 0),
      conf_info_reg3             => bank(FUSEML_RTL_REG3_REG)(31 downto 0),
      conf_info_reg1             => bank(FUSEML_RTL_REG1_REG)(31 downto 0),
      conf_info_reg6             => bank(FUSEML_RTL_REG6_REG)(31 downto 0),
      conf_info_reg7             => bank(FUSEML_RTL_REG7_REG)(31 downto 0),
      conf_info_reg4             => bank(FUSEML_RTL_REG4_REG)(31 downto 0),
      conf_info_reg5             => bank(FUSEML_RTL_REG5_REG)(31 downto 0),
      clk                        => clk,
      acc_rst                    => acc_rst,
      conf_done                  => conf_done,
