...
package sld_devices is
  ...
  constant HLSCFG_FUSEML_RTL_BASIC_DMA64 : hlscfg_t := 1;
  constant HLSCFG_FUSEML_RTL_IMPL : hlscfg_t := 2;
  ...
  constant SLD_FUSEML_RTL : devid_t := 16#04a#;
...
-- pragma translate_off
  ...
  constant sld_device_table : dtable_t := (
    ...
    SLD_FUSEML_RTL => "Accelerator FUSEML             ",
