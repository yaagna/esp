...
entity l2 is
    ...
    port (
      ...
      l2_inval_data_addr        : out std_logic_vector(31 downto 0);
      l2_inval_data_hprot       : out std_logic_vector(1 downto 0);
      l2_bresp_valid            : out std_ulogic;
      l2_bresp_data             : out std_logic_vector(1 downto 0);
...
entity l2_spandex is
    ...
    port (
      ...
      l2_cpu_req_data_dcs       : in  std_logic_vector(1 downto 0);
      l2_cpu_req_data_pred_cid  : in  std_logic_vector(3 downto 0);
      l2_fwd_in_valid           : in  std_ulogic;
      l2_fwd_in_data_coh_msg    : in  std_logic_vector(4 downto 0);
      l2_fwd_in_data_addr       : in  std_logic_vector(27 downto 0);
      l2_fwd_in_data_req_id     : in  std_logic_vector(3 downto 0);
      l2_fwd_in_data_word_mask  : in std_logic_vector(1  downto 0);
      l2_fwd_in_data_line       : in std_logic_vector(127  downto 0);
      l2_rsp_in_valid           : in  std_ulogic;
      l2_rsp_in_data_coh_msg    : in  std_logic_vector(3 downto 0);
      l2_rsp_in_data_addr       : in  std_logic_vector(27 downto 0);
      l2_rsp_in_data_line       : in  std_logic_vector(127 downto 0);
      l2_rsp_in_data_word_mask  : in std_logic_vector(1  downto 0);
      l2_rsp_in_data_invack_cnt : in  std_logic_vector(3 downto 0);
      l2_flush_valid            : in  std_ulogic;
      l2_flush_data             : in  std_ulogic;
      l2_rd_rsp_ready           : in  std_ulogic;
      ...
      l2_bresp_data             : out std_logic_vector(1 downto 0);
      l2_req_out_valid          : out std_ulogic;
      l2_req_out_data_coh_msg   : out std_logic_vector(3 downto 0);
      l2_req_out_data_hprot     : out std_logic_vector(1 downto 0);
      l2_req_out_data_addr      : out std_logic_vector(27 downto 0);
      l2_req_out_data_line      : out std_logic_vector(127 downto 0);
      l2_req_out_data_word_mask : out std_logic_vector(1  downto 0);
      l2_rsp_out_valid          : out std_ulogic;
      l2_rsp_out_data_coh_msg   : out std_logic_vector(3 downto 0);
      l2_rsp_out_data_req_id    : out std_logic_vector(3 downto 0);
      l2_rsp_out_data_to_req    : out std_logic_vector(1 downto 0);
      l2_rsp_out_data_addr      : out std_logic_vector(27 downto 0);
      l2_rsp_out_data_line      : out std_logic_vector(127 downto 0);
      l2_rsp_out_data_word_mask : out std_logic_vector(1  downto 0);
      l2_fwd_out_valid          : out std_ulogic;
      l2_fwd_out_data_coh_msg   : out std_logic_vector(3 downto 0);
      l2_fwd_out_data_req_id    : out std_logic_vector(3 downto 0);
      l2_fwd_out_data_to_req    : out std_logic_vector(1 downto 0);
      l2_fwd_out_data_addr      : out std_logic_vector(27 downto 0);
      l2_fwd_out_data_line      : out std_logic_vector(127 downto 0);
      l2_fwd_out_data_word_mask : out std_logic_vector(1  downto 0);
      l2_stats_valid            : out std_ulogic;
      l2_stats_data             : out std_ulogic;
      l2_fence_ready            : out std_ulogic;
      l2_fence_valid            : in  std_ulogic;
      l2_fence_data             : in  std_logic_vector(1 downto 0)
    );

end entity l2_spandex;


architecture mapping of l2_spandex is
...
entity llc_spandex is
    ...
    port (
      ...
      llc_req_in_data_valid_words  : in std_logic_vector(0 downto 0);
      llc_req_in_data_line         : in std_logic_vector(127  downto 0);
      llc_req_in_data_word_mask    : in std_logic_vector(1  downto 0);
      llc_req_in_data_req_id       : in std_logic_vector(3 downto 0);
      llc_dma_req_in_valid             : in std_ulogic;
      ...
      llc_dma_req_in_data_line         : in std_logic_vector(127 downto 0);
      llc_dma_req_in_data_req_id       : in std_logic_vector(5 downto 0);
      llc_dma_req_in_data_word_mask    : in std_logic_vector(1  downto 0);
      llc_rsp_in_valid             : in std_ulogic;
      llc_rsp_in_data_coh_msg      : in std_logic_vector(3 downto 0);
      llc_rsp_in_data_addr         : in std_logic_vector(27 downto 0);
      llc_rsp_in_data_line         : in std_logic_vector(127 downto 0);
      llc_rsp_in_data_word_mask    : in std_logic_vector(1  downto 0);
      llc_rsp_in_data_req_id       : in std_logic_vector(3 downto 0);
      llc_mem_rsp_valid            : in std_ulogic;
      llc_mem_rsp_data_line        : in std_logic_vector(127 downto 0);
      llc_rst_tb_valid             : in std_ulogic;
      ...
      llc_rsp_out_data_addr        : out std_logic_vector(27 downto 0);
      llc_rsp_out_data_line        : out std_logic_vector(127 downto 0);
      llc_rsp_out_data_word_mask   : out std_logic_vector(1  downto 0);
      llc_rsp_out_data_invack_cnt  : out std_logic_vector(3 downto 0);
      llc_rsp_out_data_req_id      : out std_logic_vector(3 downto 0);
      llc_rsp_out_data_dest_id     : out std_logic_vector(3 downto 0);
      llc_rsp_out_data_word_offset : out std_logic_vector(0 downto 0);
      ...
      llc_dma_rsp_out_data_dest_id     : out std_logic_vector(3 downto 0);
      llc_dma_rsp_out_data_word_offset : out std_logic_vector(1 downto 0);
      llc_dma_rsp_out_data_word_mask   : out std_logic_vector(1  downto 0);
      llc_fwd_out_valid            : out std_ulogic;
      llc_fwd_out_data_coh_msg     : out std_logic_vector(4 downto 0);
      llc_fwd_out_data_addr        : out std_logic_vector(27 downto 0);
      llc_fwd_out_data_req_id      : out std_logic_vector(3 downto 0);
      llc_fwd_out_data_dest_id     : out std_logic_vector(3 downto 0);
      llc_fwd_out_data_word_mask   : out std_logic_vector(1  downto 0);
      llc_fwd_out_data_line        : out std_logic_vector(127  downto 0);
      llc_mem_req_valid            : out std_ulogic;
      llc_mem_req_data_hwrite      : out std_ulogic;
      llc_mem_req_data_hsize       : out std_logic_vector(2 downto 0);
      llc_mem_req_data_hprot       : out std_logic_vector(1 downto 0);
...
end entity llc_spandex;


architecture mapping of llc_spandex is
