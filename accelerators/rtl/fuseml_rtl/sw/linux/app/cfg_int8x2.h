...
#ifndef __ESP_CFG_003_H__
#define __ESP_CFG_003_H__
...
struct fuseml_rtl_access fuseml_cfg_003[] = {
	{
		/* <<--descriptor-->> */
		.reg5 = REG5,
		.reg4 = REG4,
...
esp_thread_info_t cfg_003[] = {
	{
		.run = true,
		.devname = "fuseml_rtl.0",
		.ioctl_req = FUSEML_RTL_IOC_ACCESS,
		.esp_desc = &(fuseml_cfg_003[0].esp),
	}
};

#endif /* __ESP_CFG_003_H__ */
