...
#ifndef __ESP_CFG_008_H__
#define __ESP_CFG_008_H__
...
struct fuseml_rtl_access fuseml_cfg_008[] = {
	{
		/* <<--descriptor-->> */
		.reg5 = REG5,
		.reg4 = REG4,
...
esp_thread_info_t cfg_008[] = {
	{
		.run = true,
		.devname = "fuseml_rtl.0",
		.ioctl_req = FUSEML_RTL_IOC_ACCESS,
		.esp_desc = &(fuseml_cfg_008[0].esp),
	}
};

#endif /* __ESP_CFG_008_H__ */
