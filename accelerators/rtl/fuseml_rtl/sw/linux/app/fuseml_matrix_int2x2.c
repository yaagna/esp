...
void generate_random_matrix(int matrix[SIZE][SIZE]) {
    ...
    // Fill the matrix with random values between 0 and 3
...
*/
    ...
    unsigned int weight_hexadecimal_input_0[16];
    for (int i = 0; i < 16; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    unsigned int weight_hexadecimal_input_1[16];
    for (int i = 0; i < 16; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    unsigned int weight_hexadecimal_input_2[16];
    for (int i = 0; i < 16; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    unsigned int weight_hexadecimal_input_3[16];
    for (int i = 0; i < 16; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    unsigned int input_hexadecimal_input_0[32];
    for (int i = 0; i < 32; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    unsigned int input_hexadecimal_input_1[32];
    for (int i = 0; i < 32; i++){
        for (int j = 0; j < 32; j++){
...
*/
    ...
    ///////////////////// Input Stream //////////////////////
    unsigned int input_vector_stream[3084];
    for (int j = 0; j < 3; j++){
        if (j == 0){
            for (int i = 0; i < 514; i++){
    ...
    static int32_t in_buffs_2x2[3084];
